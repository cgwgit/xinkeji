    ...
    <div class="col-lg-6">
        ...
        <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select class="form-control" name="typeId">
                        ...
                        <?php if(is_array($LogisticsTypes)): foreach($LogisticsTypes as $key=>$LogisticsType): ?><option value="<?php echo ($LogisticsType["Id"]); ?>"><?php echo ($LogisticsType["typeName"]); ?></option><?php endforeach; endif; ?>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" name="release" class="form-control" placeholder="请输入发布人">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">货物名称:</label>
                <div class="col-sm-5">
                    <input type="text" name="goodsName" class="form-control" placeholder="请输入货物名称">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">装货地:</label>
                <div class="col-sm-5">
                    <input type="text" name="loadingAddr" class="form-control" placeholder="请输入装货地">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">卸货地:</label>
                <div class="col-sm-5">
                    <input type="text" name="unloadingAddr" class="form-control" placeholder="请输入卸货地">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" name="Price" class="form-control" placeholder="请输入数字">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <div class="input-group">
                        <input type="text"  name="surplus"class="form-control" placeholder="请输入数字">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" name="allowProportion" class="form-control" placeholder="0.0028">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" name="lackPrice" class="form-control" placeholder="请输入数字">
                        <span class="input-group-addon">元/吨</span>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select class="form-control" name="payWay">
                        ...
                        <option value="2">发货付款</option>
                        <option value="3">发货定金-货到结款</option>
						<option value="4">回单结算</option>
                    </select>
                </div>
            </div>
