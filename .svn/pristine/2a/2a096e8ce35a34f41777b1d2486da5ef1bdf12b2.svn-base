    ...
    <div class="col-lg-6">
        ...
        <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" name="title" value="<?php echo ($IntegralMall["title"]); ?>" class="form-control" placeholder="请输入标题">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" name="integral" value="<?php echo ($IntegralMall["integral"]); ?>" class="form-control" placeholder="请输入数字">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" name="freight" value="<?php echo ($IntegralMall["freight"]); ?>" class="form-control" placeholder="请输入数字">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        <input type="text" name="stock" value="<?php echo ($IntegralMall["stock"]); ?>" class="form-control" placeholder="请输入数字">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <textarea name="content" style="width:800px;height:400px;visibility:hidden;"><?php echo ($IntegralMall["content"]); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" name="uploadImg" value="<?php echo ($IntegralMall["uploadImg"]); ?>" class="form-control" id="urlUpLoad" placeholder="请上传图片">
            ...
            <input type="hidden" name="Id" value="<?php echo ($IntegralMall["Id"]); ?>">
            <div class="form-group">
