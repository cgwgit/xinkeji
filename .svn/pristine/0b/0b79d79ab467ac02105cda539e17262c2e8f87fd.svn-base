...
<!--    <div class="user_submit_hint hint_error">注册成功，请完善详细信息</div>-->
    <form name="register" method="post" id="register-form">
        <ul class="user_form_group">
            <li>
                <span>银 行 卡</span>
                <span><input type="number" name="bankCard" placeholder="输入银行卡号" value="<?php echo ($UserMobileNo["bankCard"]); ?>"></span>
            </li>
            <li>
                <span>银 行 户 名</span>
                <span><input type="text" name="bankName" placeholder="输入银行户名" value="<?php echo ($UserMobileNo["bankName"]); ?>"></span>
            </li>
            <li>
                <span>开 户 行</span>
                <span><input type="text" name="bankOpen" placeholder="输入开户行" value="<?php echo ($UserMobileNo["bankOpen"]); ?>"></span>
            </li>
        </ul>
